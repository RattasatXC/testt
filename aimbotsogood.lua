...
Notify({
        Description = "AIMBOT MAKE BY RATTASATX";
        Title = "XEROXSTOREGODYOUKNOW!";
        Duration = 10;
        
})

StarterGui:SetCore("SendNotification", {
    Title = "AIMBOT edited By RATTASATX",
    Text = "GOGOGO BROOOO!",
    Duration = 10,
})
local flySpeed = 50  
...
local window = library.new('XEROXSTORE  |  AIMBOT MENU', 'XEROXSTORE  |  AIMBOT MENU')

local tab = window.new_tab('rbxassetid://4483345998')

local section1 = tab.new_section('Main')
local section2 = tab.new_section('Misc')
local section3 = tab.new_section('Soon...?')
